...
this['omo-hello'].svelte = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			section.textContent = "Hello Omo 1";
    			this.c = noop;
    			add_location(section, file, 13, 0, 304);
    		},
    ...
    class Omo_hello extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>section{--bg-opacity:1;background-color:#63b3ed;background-color:rgba(99, 179, 237, var(--bg-opacity));--text-opacity:1;color:#fff;color:rgba(255, 255, 255, var(--text-opacity))}</style>`;
